...
<html>
    ...
    <body>
        ...
        <form action="test" method="post">
            <ul>
                <li>
                    <input type="submit" name="decision" value="delete Product" class="btn-cart" align="middle" >
                </li>
            </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="preview" title="Preview"> <img src="images/imagesCAE1YIYE.jpg" alt="Delete Product"  width="800" height="400"> <span class="icon"></span></a> <span>Customer</span>                            </li>
