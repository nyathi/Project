                                    ...
                                    %>
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <input type="checkbox" name="items" value="<%=prod.getId()%>"/><%=prod.getItemName()%></td>
                                        <td><%=qty%></td>
                                        <%
                                            double cost=qty*prod.getItemPrice();   
                                            totalcost+=cost;
%>
                                        <td><b>R <%=decimalFormat.format(cost)%></b></td>
                                        ...
                                        <input type="submit" name="decision" class="btn-cart" value="Remove"/>
                                    </form>
                                        <em></em>
                                        <center><a href="transaction.jsp" class="btn-cart">Checkout</a></center>
                                         <%
                                            }else
                                             {
                                        %>
